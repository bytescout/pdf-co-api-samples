...
def replaceImageFromPdf(uploadedFileUrl, destinationFile):
    ...
    url = "{}/pdf/edit/replace-text-with-image?async={}&name={}&password={}&url={}&searchString=/creativecommons.org/licenses/by-sa/3.0/&replaceImage=https://bytescout-com.s3.amazonaws.com/files/demo-files/cloud-api/image-to-pdf/image1.png".format(
        BASE_URL,
        Async,
