## How to convert PDF to XML asynchronously for PDF to XML API in PHP and PDF.co Web API

### Learn how to convert PDF to XML asynchronously to have PDF to XML API in PHP
