## How to convert PDF to XLSX from URL for PDF to excel API in cURL with PDF.co Web API
...
set QUERY="https://api.pdf.co/v1/pdf/convert/to/xlsx?name=%RESULT_FILE_NAME%&password=%PASSWORD%&pages=%PAGES%&url=%SOURCE_FILE_URL%"
