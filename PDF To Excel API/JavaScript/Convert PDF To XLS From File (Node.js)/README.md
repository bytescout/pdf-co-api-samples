## How to convert PDF to XLS from file (node for PDF to excel API in JavaScript using PDF.co Web API

### Learn how to convert PDF to XLS from file (node to have PDF to excel API in JavaScript
