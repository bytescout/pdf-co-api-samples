## How to convert PDF to XLSX from uploaded file (node for PDF to excel API in JavaScript with PDF.co Web API

### See how to convert PDF to XLSX from uploaded file (node to have PDF to excel API in JavaScript
