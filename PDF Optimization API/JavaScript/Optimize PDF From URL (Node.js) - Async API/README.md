## How to optimize PDF from URL (node for PDF optimization API in JavaScript using PDF.co Web API
...
var queryPath = `/v1/pdf/optimize?name=${path.basename(DestinationFile)}&password=${Password}&url=${SourceFileUrl}&async=True`;
var reqOptions = {
    host: "api.pdf.co",
