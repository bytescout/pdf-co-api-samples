...
$query = "https://api.pdf.co/v1/pdf/edit/replace-text?name={0}&password={1}&url={2}&async={3}&searchString=The most conspicuous feature of&replaceString=replaced text" -f `
