...
##### **ReplaceTextFromUploadedFile.js:**
...
function replaceStringFromPdf(apiKey, uploadedFileUrl, password, destinationFile) {
    ...
    var queryPath = `/v1/pdf/edit/replace-text?name=${path.basename(destinationFile)}&password=${password}&url=${uploadedFileUrl}&searchString=The most conspicuous feature of&replaceString=replaced text`;
    let reqOptions = {
        host: "api.pdf.co",
        path: encodeURI(queryPath),
        method: "GET",
