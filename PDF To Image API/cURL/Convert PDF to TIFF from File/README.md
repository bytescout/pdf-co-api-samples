## How to convert PDF to TIFF from file for PDF to image API in cURL using PDF.co Web API

### How to convert PDF to TIFF from file in cURL with easy ByteScout code samples to make PDF to image API. Step-by-step tutorial
...
##### **Convert-PDF-to-TIFF-from-File.cmd:**
...
set QUERY="https://api.pdf.co/v1/pdf/convert/to/tiff?name=%RESULT_FILE_NAME%&password=%PASSWORD%&pages=%PAGES%"
echo %QUERY%
