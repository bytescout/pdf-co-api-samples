## How to convert PDF to TIFF from uploaded file for PDF to image API in Java using PDF.co Web API

### Learn how to convert PDF to TIFF from uploaded file to have PDF to image API in Java
